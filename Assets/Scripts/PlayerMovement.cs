...
public class PlayerMovement : MonoBehaviour
{
    ...
    float wallJumpTimer;
    public Vector2 wallJumpPower = new Vector2(1f, 10f);
    ...
    {
        if (Physics2D.OverlapBox(groundCheckPos.position, groundCheckSize, 0, groundLayer)) // checks if set box overlaps with gorund 
        {
